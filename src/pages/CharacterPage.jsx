...
import { clearCharacterDetail, clearQuoteError, fetchCharacterDetail, fetchRandomQuote } from "../store/slices/characterSlice";
...
const CharacterPage = () => {
    ...
    const { detail: character, isLoadingDetails, quoteError } = useSelector(state => state.character)
    ...
    return (
        <>
            <ErrorAlert
                error={quoteError}
                onRetry={() => dispatch(fetchRandomQuote(character?.name))}
                onClose={() => dispatch(clearQuoteError())}
            />
